...
window.ROOM_CATALOG = {
 ...
 premium: { name:'きこりんビジネスプレミアム', short:'ビジネスプレミアム', price:12800, capacity:2, image:'assets/rooms/premium-preview.jpg', title:'靴を脱いで、木の部屋へ。', description:'壁・天井・床の木質感と、仕事にも使えるデスク。玄関に靴を脱ぐスペースと靴収納を設け、室内ではゆったりと過ごせます。', spec:'従来の客室 ／ ダブルベッド1台 ／ 定員1〜2名（設定例）', features:['壁・天井・床に木を取り入れた内装','靴を脱ぐ玄関・靴収納・室内用スリッパ','ワークデスクと窓辺のラウンジ'] },
 ...
 standard: { name:'普通の部屋（スタンダード）', short:'普通の部屋', price:9800, capacity:2, image:'reservation/assets/double-room.avif', title:'シンプルで快適な、いつもの客室。', description:'絨毯の床と一般的なホテルの内装。旅や出張に使いやすい、スタンダードな客室です。', spec:'通常客室 ／ ダブルベッド1台 ／ 定員1〜2名（設定例）', features:['Wi-Fi・テレビ','バス・トイレ','通常のホテルアメニティ'] }
};
